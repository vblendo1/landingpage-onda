...
>(
  (
    ...
    React.useEffect(() => {
      if (plugins && carouselRef.current && typeof window !== 'undefined') {
        import('embla-carousel-react').then(({ default: useEmblaCarousel }) => {
          ...
          if (carouselRef.current) {
            emblaRef(carouselRef.current)
          }

          setInternalApi(emblaApi as unknown as CarouselApi)
          if (setApi) setApi(emblaApi as unknown as CarouselApi)
        })
      }
    }, [opts, orientation, plugins, setApi])
